...
curl https://packages.microsoft.com/config/fedora/34/prod.repo | sudo tee /etc/yum.repos.d/microsoft-prod.repo
...
sudo curl https://www.scala-sbt.org/sbt-rpm.repo | sudo tee /etc/yum.repos.d/sbt-rpm.repo
